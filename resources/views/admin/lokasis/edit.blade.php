...
@section('page-title', 'Edit Lokasi Donor')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Edit Lokasi Donor</h1>
                    <p class="text-gray-600">Perbarui informasi lokasi {{ $lokasi->nama }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="kota" 
                                ...
                                <option value="Jakarta Pusat" {{ old('kota', $lokasi->kota) == 'Jakarta Pusat' ? 'selected' : '' }}>Jakarta Pusat</option>
                                <option value="Jakarta Utara" {{ old('kota', $lokasi->kota) == 'Jakarta Utara' ? 'selected' : '' }}>Jakarta Utara</option>
                                <option value="Jakarta Selatan" {{ old('kota', $lokasi->kota) == 'Jakarta Selatan' ? 'selected' : '' }}>Jakarta Selatan</option>
                                <option value="Jakarta Barat" {{ old('kota', $lokasi->kota) == 'Jakarta Barat' ? 'selected' : '' }}>Jakarta Barat</option>
                                <option value="Jakarta Timur" {{ old('kota', $lokasi->kota) == 'Jakarta Timur' ? 'selected' : '' }}>Jakarta Timur</option>
                            </select>
                            @error('kota')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="alamat" 
                                  ...
                                  placeholder="Masukkan alamat lengkap lokasi donor">{{ old('alamat', $lokasi->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="date" 
                                   ...
                                   value="{{ old('tanggal_operasional', $lokasi->tanggal_operasional ? $lokasi->tanggal_operasional->format('Y-m-d') : '') }}"
                        ...
                        <div>
                            ...
                            <input type="time" 
                                   id="jam_buka" 
                                   name="jam_buka" 
                                   value="{{ old('jam_buka', $lokasi->jam_buka) }}"
                        ...
                        <div>
                            ...
                            <input type="time" 
                                   id="jam_tutup" 
                                   name="jam_tutup" 
                                   value="{{ old('jam_tutup', $lokasi->jam_tutup) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   id="kontak" 
                                   name="kontak" 
                                   value="{{ old('kontak', $lokasi->kontak) }}"
                        ...
                        <div>
                            ...
                            <select id="jenis" 
                                ...
                                <option value="kota" {{ old('jenis', $lokasi->jenis) == 'kota' ? 'selected' : '' }}>PMI Kota</option>
                                <option value="provinsi" {{ old('jenis', $lokasi->jenis) == 'provinsi' ? 'selected' : '' }}>PMI Provinsi</option>
                                <option value="cabang" {{ old('jenis', $lokasi->jenis) == 'cabang' ? 'selected' : '' }}>PMI Cabang</option>
                            </select>
                            @error('jenis')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="mb-8">
                    ...
                    <div class="mt-4">
                        <button type="button" 
                            ...
                            Perbarui dengan Lokasi Saat Ini
                        </button>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" 
                                  ...
                                  placeholder="Tambahkan deskripsi atau informasi tambahan tentang lokasi ini...">{{ old('deskripsi', $lokasi->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <img src="{{ asset($lokasi->gambar) }}" alt="{{ $lokasi->nama }}" class="h-32 w-32 object-cover rounded-lg border">
                        </div>
                        @endif
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="gambar" class="relative cursor-pointer bg-white rounded-md font-medium text-red-600 hover:text-red-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-red-500">
                                        <span>{{ $lokasi->gambar ? 'Ganti gambar' : 'Upload gambar' }}</span>
