    ...
    <nav class="flex-1 px-4 py-6">
        <ul class="space-y-2">
            ...
            @if(Auth::check() && Auth::user()->role === 'admin')
                ...
                <li>
                    <a href="/admin/donors" class="flex items-center px-4 py-3 text-white hover:bg-red-700 rounded-lg transition-colors {{ request()->routeIs('analytics') ? 'bg-red-700' : '' }}">
                ...
                <li>
                    <a href="/admin/lokasis" class="flex items-center px-4 py-3 text-white hover:bg-red-700 rounded-lg transition-colors {{ request()->routeIs('reports.*') ? 'bg-red-700' : '' }}">
